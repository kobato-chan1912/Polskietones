...
@include('webpage.layouts.head', [
    'og_title' => "Pobierz Kaczor Donald $category->category_name $song->title",
    'og_des' => '',
    'title' => 'Pobierz darmowy dzwonek mp3',
])
            ...
            <div class="container">
                    ...
                    <div class="col-md-12">
                        <div class="box">
                            ...
                            <div class="post_container">
                                ...
                                <div class="post_head">
                                    <h1 class="post_name">Tono de llamada {{ $song->title }}</h1>
                                    <script>
                                        var jQInit = jQInit || [];
                                    ...
                                    <div id="jquery_jplayer_1" class="jp-jplayer" style="width: 0px; height: 0px;"><img
                                            ...
                                            src="{{ route('dlDownload') . '?id=' . $song->id }}"></audio></div>
                                    <div id="jp_container_1" class="jp-audio" role="application"
                                        aria-label="media player" style="">
                                        <div class="jp-type-single">
                                            <div class="jp-gui jp-interface">
                                                ...
                                                <div class="jp-time-holder">
                                                    ...
                                                    <div class="jp-duration" role="timer" aria-label="duration">-00:40
                                                    </div>
                ...
                <div class="jp-title" aria-label="title">&nbsp;</div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="row" style="text-align:center;">
                                            <div class="col-md-6">
                                                <a href="{{ route('dlDownload') . '?id=' . $song->id }}"
                                                    style="padding: 8px;margin-top: 10px;"
                                                    class="btn_download btn btn-success" target="_blank"
                                                    rel="nofollow" title="Download {{ $song->title }}">Download MP3<i
                        ...
                        <div id="download-ringtone" class="overlay">
                            ...
                            <div class="ads">
                                ...
                                <ins class="adsbygoogle" style="display:block"
                                    data-ad-client="ca-pub-5750925066811073"
                            ...
                            <div class="popup">
                                ...
                                <div class="popup-content" style="display: flex;">
                                    ...
                                    <div class="box-cross mb-20">
                                        <div class="bc-title">{{ $song->title }} Dzwonki</div>
                                        <div class="bc-body wrap-box-mod">
                                            ...
                                            <div class="links">
                                                <div class="item item-obb">
                                                    <span>MP3 File:</span>
                                                    <a href="{{ route('dlDownload') . '?id=' . $song->id }}"
                                                        class="btn btn-green">Ściągnij mp3</a>
                                                </div>
                                    ...
                                    <div class="post_qrcode">
                                        <img src="https://chart.googleapis.com/chart?chs=130x130&amp;cht=qr&amp;chl={{ env('WEBPAGE_URL') . $song->url }}"
                                            title="qr code link" alt="scan qr code to download">
                                    </div>
                                    <!-- end bk -->
                                </div>
                            </div>
                            <div class="download-err">
                                <span>Jeśli pobieranie nie rozpocznie się w ciągu kilku sekund,</span> <a
                                    href="{{ route('dlDownload') . '?id=' . $song->id }}">kliknij tutaj!</a>
                            </div>
                    ...
                    <div class="box column-3">
                        <h3 class="title">{{ $category->category_name }} - Same genre</h3>
                                ...
                                <li class="app_item">
                                    ...
                                    <div class="starsx">
                                        ...
                                        <span><i class="fa fa-file-audio-o" aria-hidden="true"></i>
                                            {{ $song->size }}</span>
                                        <a href="/{{ $song->slug }}" class="btn_download" rel="nofollow"
                                            title=""></a>
                                    </div>
                    ...
                    <div class="ads" style="padding-bottom: 30px;">
                        <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-5750925066811073"
                            crossorigin="anonymous"></script>
                        <!-- Ads 2 - Vuông -->
                        <ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-5750925066811073"
                            data-ad-slot="4412194511" data-ad-format="auto" data-full-width-responsive="true"
                            data-adtest="{{ env('ADSENSE_TEST') }}"></ins>
                        <script>
                            (adsbygoogle = window.adsbygoogle || []).push({});
                        </script>
                    </div>
