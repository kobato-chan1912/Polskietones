            ...
            <div class="col-md-8">
                <div class="box">
                    ...
                    <div class="title single-breadcrumb">
                        ...
                        <div class="post_breadcrumbs"><span><span><a style="color: #000000 !important;" href="{{route("webPageIndex")}}">Strona główna</a> » <span><a href="/{{$category->category_slug}}" style="color: #000000 !important;" > {{$category->category_name}}</a> » <strong class="breadcrumb_last" aria-current="page">{{$song->title}}</strong></span></span></span></div>
                    </div>
                    <div class="post_container" style="background-color: white">
                        ...
                        <div class="post_info">
                            ...
                            <ul id="ringtoneInfo">
                                ...
                                <li>
                                    <label><i class="fa fa-calendar" aria-hidden="true"></i> Aktualizacja </label>
                                    <span>{{$song->created_at}}</span>
                                </li>
                                <li>
                                    <label><i class="fa fa-file-audio-o" aria-hidden="true"></i> Rozmiar </label>
                                    <span>{{$song->size}}</span>
                                </li>
                                <li>
                                    <label><i class="fa fa-download" aria-hidden="true"></i> Pliki do pobrania </label>
                                    <span>{{$song->downloads}}</span>
                                </li>
                                <li>
                                    <label><i class="fa fa-list" aria-hidden="true"></i> Genre </label>
                                    <span><a href="/{{$category->category_slug}}">{{$category->category_name}}</a> </span>
                                </li>
                            </ul>

                            <div class="mxh"><a class="share fb" href="https://www.facebook.com/sharer.php?u={{URL::current()}}" rel="nofollow" target="_blank">FaceBook</a><a class="share tw" href="https://twitter.com/home?status={{URL::current()}}" rel="nofollow" target="_blank" title="Chia s? lên Twitter">Twitter</a><br></div>
