...
[
    ...
    "og_des" => "Pobierz Darmowe Dzwonki na Telefon 2022. Syntetyzuj najnowsze dźwięki, dzwonki mp3 na telefony komórkowe w Dzwonkitones.com",
        ...
        <div class="col-md-9">
            <div class="box column-3">
                <a href="/najnowsze-dzwonki">
                    <h1 class="title"><i class="fa fa-music" aria-hidden="true"></i> Najnowszy </h1></a>
            ...
            <div class="wp-pagenavi box" role="navigation">
                <span class="pages">Página @if(request()->has('page')) {{$page}} @else 1 @endif de {{$newestSongs->lastPage()}}</span>
            ...
            <div class="box column-3">
                <a href="/najlepsze-dzwonki"><h1 class="title"><i class="fa fa-music" aria-hidden="true"></i> Najlepsze Dzwonki </h1>
                </a>

                <ul class="list_apps">
                    @php $populars = \App\Models\Song::orderBy("downloads", "desc")->where("display",1)->limit(10)->get(); @endphp
